...
namespace ProcessNote
{
    public partial class Form1 : Form
    {
        ...
        private void Processes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            long memoryUsed = currentProc.PrivateMemorySize64 / 10024;
            long cpuUsed = currentProc.PrivateMemorySize64 / 10002400;
            MemLabel2.Text = memoryUsed + " " + "kb";
            CpuLabel.Text = cpuUsed + " " + "%";
